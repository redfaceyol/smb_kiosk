      ...
      if($this->request->getGet('sid')) {
        ...
        if($shop_rows) {
          ...
          foreach($kiosk_result as $kiosk_result_item) {            
            ...
            $tmpVal["pass"] = base64_decode( ($kiosk_result_item->kioskpassword?$kiosk_result_item->kioskpassword:"1234") );
            //$tmpVal["pass"] = openssl_decrypt( base64_decode( ($kiosk_result_item->kioskpassword?$kiosk_result_item->kioskpassword:"1234") ), "AES-256-CBC", $key, 0, $iv );
