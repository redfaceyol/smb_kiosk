    ...
    <form name="modForm" id="modForm" method="post" action="/admin/shop/putShop" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-6">
            <textarea type="text" class="form-control" id="shop_addinfo" name="shop_addinfo" rows="5"><?=$shopData["shop_addinfo"]?></textarea>
          </div>
        </div>

        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="kioskpassword">키오스크비밀번호</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" id="kioskpassword" name="kioskpassword" value="" placeholder="변경시에만 입력해주세요." onkeydown="onlyNumber(this)" />
          </div>
          <div class="col-sm-3 pt-2 text-danger">변경시에만 숫자로 입력해주세요.</div>
        </div>
