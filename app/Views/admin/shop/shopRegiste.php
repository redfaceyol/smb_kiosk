    ...
    <form name="regForm" id="regForm" method="post" action="/admin/shop/postShop" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-3">
            <input type="text" readonly class="form-control" id="representative_name" name="representative_name" value="" />
            <input type="hidden" class="form-control" id="representative" name="representative" value="" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-3">
            <input type="text" class="form-control" id="tel" name="tel" value="" placeholder="- 를 제외하고 입력하세요." onkeydown="onlyNumber(this)" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-2 mb-3 mb-sm-0">
            <input type="text" readonly class="form-control" id="zipcode" name="zipcode" value=""/>
          </div>
          <div class="col-sm-1">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-6">
            <input type="text" readonly class="form-control" id="address1" name="address1" value=""/>
          </div>
        </div>
