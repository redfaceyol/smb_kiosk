      ...
      <table class="table table-hover table-bordered table-sm">
        <thead>
          <tr>
            ...
            <th width="200">업장명</th>
            <th width="200">아이디</th>
            <th width="100">Kiosk 수</th>
            <th width="100">메뉴등록 Kiosk수</th>
            <th width="180">관리</th> 
          </tr>
        </thead>
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td><?=$lt->existMenu?></td>
            <td>
              <a class="btn btn-sm btn-info" href="/admin/menu/kioskList?sid=<?=$lt->id?>&<?=$_Link?>"><i class="bx bx-edit-alt me-1"></i> 메뉴관리</a>
            </td>
          </tr>
				  <? $rowNum++; } ?>
        </tbody>
