      ...
      <div class="row">
        ...
        <div class="col-sm-8 offset-sm-1">
          ...
          <div id="category_set" class="settings">
            <form name="categoryForm" id="categoryForm" method="post" action="/admin/menu/prcCategory" enctype="multipart/form-data">
          ...
          <div id="menu_set" class="settings">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                <input type="text" readonly class="form-control-plaintext" id="ctitle" name="ctitle" value="ㅅㄷㄴㅅ" />
              </div>
            </div>
