...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">KIOSK 관리</h4>

  <!-- Basic Bootstrap Table -->
  <div class="card">
    <form name="regForm" id="regForm" method="post" action="/admin/kiosk/postKiosk">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-3">
            <input type="text" readonly class="form-control" id="shop_title" name="shop_title" value="" />
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-3">
            <select class="form-select" id="kiosktype" name="kiosktype">
              ...
              <option value="2">Table Order</option>
            </select>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-3">
            <input type="text" class="form-control" id="kiosknumber" name="kiosknumber" value="" onkeydown="onlyNumber(this)" />
          </div>
        </div>
