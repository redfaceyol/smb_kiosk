...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">KIOSK 관리<button type="button" class="btn btn-primary btn-xs btn-help" data-bs-toggle="modal" data-bs-target="#menuHelp">Help</button></h4>
      ...
      <table class="table table-hover table-bordered table-sm">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td><?=$lt->id?></td>
            <td><?=$lt->kioskcnt?></td>
            <td>설치 : <?=$lt->kioskStatus1?> / 미설치 : <?=$lt->kioskStatus0?></td>
            <td>
              <a class="btn btn-sm btn-info" href="/admin/kiosk/kioskManage?sid=<?=$lt->id?>&<?=$_Link?>"><i class="bx bx-edit-alt me-1"></i> Kiosk 관리</a>
            </td>
          </tr>
				  <? $rowNum++; } ?>
        </tbody>
